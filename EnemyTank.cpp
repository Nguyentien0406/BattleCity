...
void EnemyTank::move(const vector<Wall>& walls, const PlayerTank& player, const PlayerTank& otherPlayer, const vector<EnemyTank>& enemies) {
...
void EnemyTank::updateBullets(vector<Wall>& walls, PlayerTank& player, PlayerTank& otherPlayer, vector<EnemyTank>& enemies, Game &game) {
    for (Bullet& bullet : bullets) {
        bullet.update(walls, player, otherPlayer, enemies, game);
    }
